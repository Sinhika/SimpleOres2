...
gen_model_jsons.py --type=inventory deepslate_tin_ore
gen_model_jsons.py --type=inventory deepslate_mythril_ore
gen_model_jsons.py --type=inventory deepslate_adamantium_ore
