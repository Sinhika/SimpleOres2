...
public final class SimpleOresTiers
{
	...
	public static final Tier COPPER = TierSortingRegistry.registerTier(
			...
			new ResourceLocation(SimpleOres.MODID, "COPPER"), List.of(Tiers.WOOD), List.of(Tiers.IRON));
	...
	public static final Tier TIN = TierSortingRegistry.registerTier(
			...
			new ResourceLocation(SimpleOres.MODID, "TIN"),List.of(Tiers.WOOD), List.of(Tiers.IRON));
	...
	public static final Tier MYTHRIL = TierSortingRegistry.registerTier(
			...
			new ResourceLocation(SimpleOres.MODID, "MYTHRIL"), List.of(Tiers.STONE), List.of(Tiers.DIAMOND));
