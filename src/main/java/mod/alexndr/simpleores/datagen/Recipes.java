...
{
    private final RecipeSetBuilder setbuilder;
    ...
    {
    	 setbuilder.buildSimpleAestheticBlocks(pRecipeOutput, Ingredient.of(ModItems.adamantium_ingot.get()), "adamantium", 
    			has(ModItems.adamantium_ingot.get()));
    	 setbuilder.buildSimpleAestheticBlocks(pRecipeOutput, Ingredient.of(ModItems.mythril_ingot.get()), "mythril", 
     			has(ModItems.mythril_ingot.get()));
    	 setbuilder.buildSimpleAestheticBlocks(pRecipeOutput, Ingredient.of(ModItems.tin_ingot.get()), "tin", 
      			has(ModItems.tin_ingot.get()));
    	 setbuilder.buildSimpleAestheticBlocks(pRecipeOutput, Ingredient.of(ModItems.onyx_gem.get()), "onyx", 
       			has(ModItems.onyx_gem.get()));
    	 setbuilder.buildSimpleAestheticBlocks(pRecipeOutput, Ingredient.of(Items.COPPER_INGOT), "copper", 
    ...
    {
        setbuilder.buildSimpleToolSet(pRecipeOutput, Ingredient.of(ModTags.Items.INGOTS_COPPER), "copper", 
                                      has(ModTags.Items.INGOTS_COPPER), true);
        setbuilder.buildSimpleToolSet(pRecipeOutput, Ingredient.of(ModTags.Items.INGOTS_TIN), "tin", 
                has(ModTags.Items.INGOTS_TIN), true);
        setbuilder.buildSimpleToolSet(pRecipeOutput, Ingredient.of(ModTags.Items.INGOTS_MYTHRIL), "mythril", 
                has(ModTags.Items.INGOTS_MYTHRIL), true);
        setbuilder.buildSimpleToolSet(pRecipeOutput, Ingredient.of(ModTags.Items.INGOTS_ADAMANTIUM), "adamantium", 
                has(ModTags.Items.INGOTS_ADAMANTIUM), true);
        setbuilder.buildSimpleToolSet(pRecipeOutput, Ingredient.of(ModTags.Items.GEMS_ONYX), "onyx", 
                has(ModTags.Items.GEMS_ONYX), true);
        
        setbuilder.buildModBowRecipe(pRecipeOutput, ModItems.mythril_bow.getId(), Ingredient.of(ModTags.Items.INGOTS_MYTHRIL), 
                ModItems.mythril_rod.get(), Ingredient.of(Items.IRON_INGOT), has(ModTags.Items.INGOTS_MYTHRIL));
        
        setbuilder.buildModBowRecipe(pRecipeOutput, ModItems.onyx_bow.getId(), Ingredient.of(ModTags.Items.GEMS_ONYX), 
    ...
    {
        setbuilder.buildSimpleArmorSet(pRecipeOutput, Ingredient.of(ModTags.Items.INGOTS_COPPER), "copper", 
                                       has(ModTags.Items.INGOTS_COPPER));
        setbuilder.buildSimpleArmorSet(pRecipeOutput, Ingredient.of(ModTags.Items.INGOTS_TIN), "tin", 
                has(ModTags.Items.INGOTS_TIN));
        setbuilder.buildSimpleArmorSet(pRecipeOutput, Ingredient.of(ModTags.Items.INGOTS_MYTHRIL), "mythril", 
                has(ModTags.Items.INGOTS_MYTHRIL));
        setbuilder.buildSimpleArmorSet(pRecipeOutput, Ingredient.of(ModTags.Items.INGOTS_ADAMANTIUM), "adamantium", 
                has(ModTags.Items.INGOTS_ADAMANTIUM));
        setbuilder.buildSimpleArmorSet(pRecipeOutput, Ingredient.of(ModTags.Items.GEMS_ONYX), "onyx", 
    ...
    protected void registerStorageRecipes(RecipeOutput pRecipeOutput)
    {
        ...
        setbuilder.buildSimpleStorageRecipes(pRecipeOutput, ModItems.mythril_ingot.get(), ModBlocks.mythril_block.get(), 
                ModItems.mythril_nugget.get(), has(ModItems.mythril_ingot.get()));
        setbuilder.buildSimpleStorageRecipes(pRecipeOutput, ModItems.raw_mythril.get(), 
        		ModBlocks.raw_mythril_block.get(), null, has(ModItems.raw_mythril.get()));
        setbuilder.buildSimpleStorageRecipes(pRecipeOutput, ModItems.adamantium_ingot.get(), ModBlocks.adamantium_block.get(), 
                ModItems.adamantium_nugget.get(), has(ModItems.adamantium_ingot.get()));
        setbuilder.buildSimpleStorageRecipes(pRecipeOutput, ModItems.raw_adamantium.get(), 
        		ModBlocks.raw_adamantium_block.get(), null, has(ModItems.raw_adamantium.get()));
        setbuilder.buildSimpleStorageRecipes(pRecipeOutput, ModItems.onyx_gem.get(), ModBlocks.onyx_block.get(), 
    ...
    protected void registerMiscRecipes(RecipeOutput pRecipeOutput)
    {
        ...
        // pressure_plates
        this.setbuilder.buildSimplePressurePlate(pRecipeOutput, Ingredient.of(ModTags.Items.INGOTS_COPPER), 
                ModBlocks.copper_pressure_plate.get(), has(ModTags.Items.INGOTS_COPPER));
        this.setbuilder.buildSimplePressurePlate(pRecipeOutput, Ingredient.of(ModTags.Items.INGOTS_TIN),
                ModBlocks.tin_pressure_plate.get(), has(ModTags.Items.INGOTS_TIN));
        this.setbuilder.buildSimplePressurePlate(pRecipeOutput, Ingredient.of(ModTags.Items.INGOTS_MYTHRIL),
                ModBlocks.mythril_pressure_plate.get(), has(ModTags.Items.INGOTS_MYTHRIL));
        this.setbuilder.buildSimplePressurePlate(pRecipeOutput, Ingredient.of(ModTags.Items.INGOTS_ADAMANTIUM),
                ModBlocks.adamantium_pressure_plate.get(), has(ModTags.Items.INGOTS_ADAMANTIUM));
        this.setbuilder.buildSimplePressurePlate(pRecipeOutput, Ingredient.of(ModTags.Items.GEMS_ONYX),
    ...
    {
        setbuilder.buildOre2IngotRecipes(pRecipeOutput, Ingredient.of(ModItems.raw_adamantium.get()), ModItems.adamantium_ingot.get(), 
                has(ModItems.raw_adamantium.get().asItem()), 0.7F, 200);
        setbuilder.buildOre2IngotRecipes(pRecipeOutput, Ingredient.of(ModBlocks.adamantium_ore.get().asItem()), ModItems.adamantium_ingot.get(), 
                has(ModBlocks.adamantium_ore.get().asItem()), 0.7F, 200, "_from_ore");
        setbuilder.buildOre2IngotRecipes(pRecipeOutput, Ingredient.of(ModBlocks.deepslate_adamantium_ore.get().asItem()), ModItems.adamantium_ingot.get(), 
                has(ModBlocks.deepslate_adamantium_ore.get().asItem()), 0.7F, 200, "_from_deepslate_ore");
        setbuilder.buildOre2IngotRecipes(pRecipeOutput, Ingredient.of(ModItems.raw_mythril.get()), ModItems.mythril_ingot.get(), 
                has(ModItems.raw_mythril.get().asItem()), 0.7F, 200);
        setbuilder.buildOre2IngotRecipes(pRecipeOutput, Ingredient.of(ModBlocks.mythril_ore.get().asItem()), ModItems.mythril_ingot.get(), 
                has(ModBlocks.mythril_ore.get().asItem()), 0.7F, 200, "_from_ore");
        setbuilder.buildOre2IngotRecipes(pRecipeOutput, Ingredient.of(ModBlocks.deepslate_mythril_ore.get().asItem()), ModItems.mythril_ingot.get(), 
                has(ModBlocks.deepslate_mythril_ore.get().asItem()), 0.7F, 200, "_from_deepslate_ore");
        setbuilder.buildOre2IngotRecipes(pRecipeOutput, Ingredient.of(ModItems.raw_tin.get()), ModItems.tin_ingot.get(), 
                has(ModItems.raw_tin.get()), 0.4F, 200);
        setbuilder.buildOre2IngotRecipes(pRecipeOutput, Ingredient.of(ModBlocks.tin_ore.get().asItem()), ModItems.tin_ingot.get(), 
                has(ModBlocks.tin_ore.get().asItem()), 0.4F, 200, "_from_ore");
        setbuilder.buildOre2IngotRecipes(pRecipeOutput, Ingredient.of(ModBlocks.deepslate_tin_ore.get().asItem()), ModItems.tin_ingot.get(), 
                has(ModBlocks.deepslate_tin_ore.get().asItem()), 0.4F, 200, "_from_deepslate_ore");
        setbuilder.buildOre2IngotRecipes(pRecipeOutput, Ingredient.of(ModBlocks.onyx_ore.get().asItem()), ModItems.onyx_gem.get(), 
                has(ModBlocks.onyx_ore.get().asItem()), 1.0F, 200);
        
        setbuilder.buildVanillaRecyclingRecipes(pRecipeOutput,
    ...
    {
        setbuilder.buildOre2IngotRecipes(pRecipeOutput, 
