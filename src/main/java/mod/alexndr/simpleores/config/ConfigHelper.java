...
//      public static void bakeClient(final ModConfig config) { }
    ...
    public static void bakeServer(final ModConfig config)
    {
        ...
        SimpleOresConfig.copper_cfg = new CountRangeConfig(ConfigHolder.SERVER.serverCopperVeinCount.get(),
                ConfigHolder.SERVER.serverCopperBottomHeight.get(), 0, ConfigHolder.SERVER.serverCopperMaxHeight.get());
        ...
        SimpleOresConfig.tin_cfg = new CountRangeConfig(ConfigHolder.SERVER.serverTinVeinCount.get(),
                ConfigHolder.SERVER.serverTinBottomHeight.get(), 0, ConfigHolder.SERVER.serverTinMaxHeight.get());
        ...
        SimpleOresConfig.mythril_cfg = new CountRangeConfig(ConfigHolder.SERVER.serverMythrilVeinCount.get(),
                ConfigHolder.SERVER.serverMythrilBottomHeight.get(), 0,
        ...
        SimpleOresConfig.adamantium_cfg = new CountRangeConfig(ConfigHolder.SERVER.serverAdamantiumVeinCount.get(),
                ConfigHolder.SERVER.serverAdamantiumBottomHeight.get(), 0,
        ...
        SimpleOresConfig.onyx_cfg = new CountRangeConfig(ConfigHolder.SERVER.serverOnyxVeinCount.get(),
                ConfigHolder.SERVER.serverOnyxBottomHeight.get(), 0, ConfigHolder.SERVER.serverOnyxMaxHeight.get());
