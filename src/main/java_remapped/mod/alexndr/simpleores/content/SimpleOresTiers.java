...
public final class SimpleOresTiers
{
	...
	public static final Tier COPPER = TierSortingRegistry.registerTier(
			new SimpleTier(Tiers.STONE.getLevel(), 185, 4.0f, 1.0f, 8, COPPER_TAG,()->Ingredient.of(Items.COPPER_INGOT)),
	...
	public static final Tier TIN = TierSortingRegistry.registerTier(
			new SimpleTier(Tiers.STONE.getLevel(), 220, 3.5F, 1.0F, 8, TIN_TAG, ()->Ingredient.of( ModItems.tin_ingot.get())), 
	...
	public static final Tier MYTHRIL = TierSortingRegistry.registerTier(
			new SimpleTier(Tiers.IRON.getLevel(), 800, 8.0F, 3.0F, 12, MYTHRIL_TAG, ()->Ingredient.of( ModItems.mythril_ingot.get())),  
	...
	public static final Tier ADAMANTIUM = TierSortingRegistry.registerTier(
			new SimpleTier(Tiers.IRON.getLevel(),1150, 14.0F, 3.0F, 3, ADAMANTIUM_TAG, ()->Ingredient.of( ModItems.adamantium_ingot.get())),
	...
	public static final Tier ONYX = TierSortingRegistry.registerTier(
			new SimpleTier(Tiers.NETHERITE.getLevel(), 3280, 10.0F, 5.0F, 15, ONYX_TAG, ()->Ingredient.of( ModItems.onyx_gem.get())), 
